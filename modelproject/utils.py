...
def v1_func(c1, m1, rho, beta, r, delta, v2_interp_func):
    ...
    total = delta * exp_v2_low + delta * exp_v2_high

    return utility_crra(c1, rho) + beta*total

def interp(m2_grid, v2_grid):
    func = interpolate.RegularGridInterpolator((m2_grid,), v2_grid,
                                                    bounds_error=False,fill_value=None)
    return func

def solve_period_1(m1_grid, rho, beta, r, delta, v2_interp_func):
    ...
    for i,m1 in enumerate(m1_grid):
        ...
        # Defining obj func
        obj = lambda c1: -v1_func(c1, m1, rho, beta, r, delta, v2_interp_func)
...
def solve_period_2(rho, kappa, gamma):
    ...
    # Defining grids
    m2_grid = np.linspace(1e-8,4,100)
...
def solvez(rho, kappa, gamma, m1_grid, beta, r, delta):
    ...
    m1_grid, v1_grid, c1_grid = solve_period_1(m1_grid, rho, beta, r, delta, v2_interp_func)
